...
describe('Register', () => {
  it('should navigate to the sign page', () => {
    cy.intercept({url:'http://localhost:8080/users',method:"post"}).as('user')
    cy.intercept({url:'http://localhost:8080/users/me',method:"get"}).as('me')
    ...
    cy.get('#cellphone').type('16994175820')
